...
merge into mpa_ratings (mpa_rating_id, mpa_rating_name) values (1, 'G');
merge into mpa_ratings (mpa_rating_id, mpa_rating_name) values (2, 'PG');
merge into mpa_ratings (mpa_rating_id, mpa_rating_name) values (3, 'PG-13');
merge into mpa_ratings (mpa_rating_id, mpa_rating_name) values (4, 'R');
merge into mpa_ratings (mpa_rating_id, mpa_rating_name) values (5, 'NC-17');